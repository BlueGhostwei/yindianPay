...
/**
 * 这个程序实现快捷支付短信认证接口调用示例
 * 机构号，秘钥，请求地址，请在KFRequestUtil.java修改。
 * 2018-05-18
 */
class BindCardPayComfirm {
    ...
    public function test(){
        try {
            ...
            */
            ...
            //下单令牌
            $reqData.put["adddata1" = "asdfadfadsf";
            //短信验证码
            $reqData.put["vercode" = "123456";
            //用户编号，业务系统商户用户唯一标识
...
$agentTrans = new BindCardPayComfirm();
$agentTrans->test();
